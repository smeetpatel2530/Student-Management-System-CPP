...
float CPA(stud& x)
{
    // Directly use scores out of 10 and calculate weighted average
    x.score.CPA = (x.score.math * 4 +
                   x.score.physics * 4 +
                   x.score.chemistry * 2 +
                   x.score.literature * 3 +
                   x.score.english * 3) / 16;
    return x.score.CPA;
}
...
void InputMenu1Start1()
{
	...
	cout << "\t\t\t\t" << "|   |     For example: Your name input: | smeet       patel  |  will convert to  |Smeet Patel|                            |" << endl;
	cout << "\t\t\t\t" << "|   |                                                                                                                     |" << endl;
	...
	cout << "\t\t\t\t" << "|   |                       | Enter student name:                smeet       patel            |                           |" << endl;
	cout << "\t\t\t\t" << "|   |                       | Enter Gender (Male/Female):        M                            |                           |" << endl;
	cout << "\t\t\t\t" << "|   |                       | Enter student's date of birth:     12 12 2000                   |                           |" << endl;
	cout << "\t\t\t\t" << "|   |                       | Enter the grade of the student:    Smeet Prakashbhai Patel      |                           |" << endl;
	...
	cout << "\t\t\t\t" << "|                                                                                    Program written by Smeet Patel               |" << endl;
	cout << "\t\t\t\t" << "|_________________________________________________________________________________________________________________________|" << endl;
	cout << endl;
}
